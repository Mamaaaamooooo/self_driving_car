...
def FetchInfoAndDisplay(Mid_lane_edge, Mid_lane, Outer_lane, frame, Offset_correction):
    ...
    # 3. keep only thos edge that are part of MidLane

    Mid_lane_edge = cv2.bitwise_and(Mid_lane_edge, Mid_lane)
    # 4. combine Mid and outlane to get lanes combined and extract its contours
    ...
    #6. remove midlane region from projectedlane by extracting the midless mask
